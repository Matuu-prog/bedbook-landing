...
const apartments = [
    { name: "Alfa", img: "/images/alfa.webp" },
    { name: "Bravo", img: "/images/Bravo.webp" },
    { name: "Charlie", img: "/images/Charly.webp" },
    { name: "Delta", img: "/images/Delta.webp" },
    { name: "Eco", img: "/images/Eco.webp" },
    { name: "Foxtrot", img: "/images/foxtrot.webp" },
    { name: "Golf", img: "/images/golf.webp" },
    { name: "India", img: "/images/india.webp" }
];
            ...
            <div className="w-full px-6 md:px-12 lg:px-24 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="order-2 md:order-1 relative h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden shadow-2xl">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <img
                                src={apartments[currentIndex].img}
